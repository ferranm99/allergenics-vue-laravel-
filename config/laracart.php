    ...
    */
    'item_model_bindings' => [
        ...
        \LukePOLO\LaraCart\CartItem::ITEM_OPTIONS => [
            'pricelist' => 'pricelist' ,// this will go to the price relation then get the value!
            'tax' => 'tax' ,// this will go to the price relation then get the value!
            'taxable' => 'taxable' ,// this will go to the price relation then get the value!
