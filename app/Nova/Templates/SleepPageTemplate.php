...
class SleepPageTemplate extends Template
{
    public static $type = 'page';
    public static $name = 'sleep-page';
    ...
    public function fields(Request $request): array
    {
      $image_custom_properties = [
        ...
        return [
            ...
            Images::make('Sleep Banner Image', 'sleep_banner_image') // second parameter is the media collection name
                ->withResponsiveImages()
                ->conversionOnIndexView('thumb')
                ->customPropertiesFields($image_custom_properties) // conversion used to display the image
                ->rules('required'),// validation rules

            Text::make('Sleep Title')
                ->rules('required'),
            ...
            Images::make('Sleep Who Image', 'sleep_who_image') // second parameter is the media collection name
                ->withResponsiveImages()
                ->conversionOnIndexView('thumb')
                ->customPropertiesFields($image_custom_properties) // conversion used to display the image
                ->rules('required'),// validation rules
            ...
            Images::make('Sleep What Results Image', 'sleep_what_results_image') // second parameter is the media collection name
                ->withResponsiveImages()
                ->conversionOnIndexView('thumb')
                ->customPropertiesFields($image_custom_properties) // conversion used to display the image
                ->rules('required'),// validation rules
            ...
            Images::make('Sleep Next Steps Image', 'sleep_next_steps_image') // second parameter is the media collection name
                ->withResponsiveImages()
                ->conversionOnIndexView('thumb')
                ->customPropertiesFields($image_custom_properties) // conversion used to display the image
                ->rules('required'),// validation rules
